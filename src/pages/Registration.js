...
function Registration() {
    ...
    const handleRegistration = async() => {
        console.log(data);
        await axios.post(`${registerDoctorURL}`, data, config)
        .then((res)=>{
                            ...
                            <div className="text-center">
                                <form className='mt-3 py-3'>
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className="col-12 col-md-4 mb-4">
                                            <input type="text" id="specialisation" className="form-control"
                                        ...
                                        <div className="col-12 col-md-4 mb-4">
                                            <input type="text" id="exp" className="form-control"
                                    ...
                                    <div className='row'>
                                        <div className="col-12 col-md-4 mb-4">
                                            <input type="text" id="regNum" className="form-control"
                                        ...
                                        <div className="col-12 col-md-4 mb-4">
                                            <input type="text" id="stamp" className="form-control"
                                        ...
                                        <div className="col-12 col-md-4 mb-4">
                                            ...
                                            value={patientLimit}
                                            onChange={event => setPatientLimit(parseInt(event.target.value))}
                                            required
                                            />
